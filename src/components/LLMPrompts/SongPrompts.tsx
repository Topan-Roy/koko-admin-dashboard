                ...
                <div className="p-6">
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      className="w-full min-h-[600px] p-4 text-sm text-[#4B5563] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 font-mono resize-y"
                      placeholder="Enter system prompt..."
                    />
                  ) : (
                    <div
                      className="text-sm text-[#4B5563] whitespace-pre-line break-words max-w-full bg-gray-50 p-6 rounded-lg border border-gray-200"
