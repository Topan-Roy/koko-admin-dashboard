      ...
      <div className="w-full pb-4">
        ...
        <div className="mt-6 px-6">
          <div className="flex items-center justify-between">
            <h1 className="text-[#1F2937] font-semibold text-[15.3px] leading-[28px]  text-xl">
              AI LLM Blocklist
            </h1>
            <div
            ...
            >
              ...
              <span className="text-[11.9px] leading-[20px] font-[400] text-[#FFFFFF] cursor-pointer  bg-gradient-to-r from-[#9458E8] via-[#A43EE7] to-[#CA00E5]">
                Add Blocked Word
              </span>
            </div>
          </div>
        ...
        {showAddForm && (
          <div className="px-6 mt-4">
            <div className="bg-white p-6 rounded-[8px] border-[1px] border-[#E5E7EB]">
              <h3 className="font-[600] text-[14px] leading-[24px] text-[#1F2937]">
                Add New LLM Blockword
              </h3>
              <p className="mt-1 font-[400] text-[11.9px] leading-[20px] text-[#4B5563]">
                Write the Word
              </p>
              <input
                type="text"
        ...
        <div className="px-6 mt-6 ">
          <div className="bg-white p-6 rounded-[8px] border-[1px] border-[#E5E7EB]">
            <p className="font-[400] text-[11.9px] leading-[20px] text-[#4B5563] inter-font">
              These words will be blocked from appearing in any content
              generated by the AI. The blocklist is applied to all story and
              song generations.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-[8px] shadow-md">
            <div>
              <table className="w-full">
                <thead>
                  <tr>
                    <th className="font-semibold text-[14px] leading-[20px] text-[#333333] text-left p-[10px] border-b-[0.5px] border-[#EBEBEB]">
                      Word
                    </th>
                    <th className="font-semibold text-[14px] leading-[20px] text-[#333333] text-left p-[10px] border-b-[0.5px] border-[#EBEBEB]">
                      Date Added
